...
#                 evaluation_df.append(['dt', tissue, acc, rocauc, y_test_tissue])
#                 if plt_confusion:
...
#                 evaluation_df.append(['dt', tissue, acc, 0, y_test_tissue])
...
#     evaluation_df.append(['dt', 'all_tissues', acc, rocauc, y_test])
...
#                 evaluation_df.append(['gbdt', tissue, acc, rocauc, y_test_tissue])
#             else:
#                 acc = metrics.accuracy_score(y_test_tissue, y_pred)
#                 evaluation_df.append(['gbdt', tissue, acc, 0, y_test_tissue])
...
#     evaluation_df.append(['gbdt', 'all_tissues', acc, rocauc, y_test])
...
#                 evaluation_df.append(['nn', tissue, acc, rocauc, y_test_tissue.count(0),
#                                       y_test_tissue.count(1)])
#             else:
#                 loss, acc = model.evaluate(X_test_tissue, y_test_tissue)
#                 evaluation_df.append(['nn', tissue, acc, 0, y_test_tissue.count(0),
#                                       y_test_tissue.count(1)])
...
#     evaluation_df.append(['nn', 'all_tissues', acc, rocauc, y_test.count(0), y_test.count(1)])
    ...
    for tissue in metadata_test['Tissue'].unique():
        ...
        if X_test_tissue.shape[0]>0:
            ...
            if len(y_test_tissue['label'].unique())>1:
                ...
                acc = metrics.accuracy_score(y_test_tissue, y_pred)
                zeros, ones = counter(y_test_tissue['label'], y_pred)
                evaluation_df.append(['ridge', tissue, acc, 0, zeros, ones])
